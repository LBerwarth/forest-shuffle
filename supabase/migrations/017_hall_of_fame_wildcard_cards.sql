-- The wildcard moor and river cards were winning the most-played slot: they
-- stand in for "any moor" / "any river", so they appear in half of all logged
-- games and score nothing. Keeps them out of the card meta.
