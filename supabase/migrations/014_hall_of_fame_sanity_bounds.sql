-- Keeps implausible scores out of the Hall of Fame and out of the percentile
-- it compares the player against. The bound is deliberately far above the real
-- tail (22 % of logged scores pass 300, 3 % pass 500) so only entries that
-- cannot come from a played game are dropped.
